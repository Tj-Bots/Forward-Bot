...
async def how_to_use(bot, query):
    buttons = [[InlineKeyboardButton('חזרה ⋟', callback_data='help')]]
    reply_markup = InlineKeyboardMarkup(buttons)
...
async def status(bot, query):
    ...
    buttons = [[
        InlineKeyboardButton('חזרה ⋟', callback_data='help'),
        InlineKeyboardButton('סטטוס שרת', callback_data='systm_sts'),
    ]]
    reply_markup = InlineKeyboardMarkup(buttons)
    await query.message.edit_text(
...
async def sys_status(bot, query):
    buttons = [[InlineKeyboardButton('חזרה ⋟', callback_data='status')]]
